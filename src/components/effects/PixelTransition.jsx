...
// NOTE: This component was removed in favor of a simpler fade transition, but may be re-added later as a fun extra effect. Keeping the code here for now to avoid losing it.
...
/**
 * PixelTransition.jsx — Disabled
 *
 * The pixel wipe transition was firing on EVERY scroll event because
 * activeSection changes as you scroll, causing repeated black screens.
 *
 * Fix: render children directly with no transition overlay.
 * The sections already have smooth scroll + reveal animations.
 */
